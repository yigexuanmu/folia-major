...
describe('resolveWebObsTarget', () => {
    beforeEach(() => {
        useStageSettingsStore.setState({ enableNowPlayingStage: false, enablePlayerCapStage: false, playerCapHost: 'localhost:8765', playerCapPlayer: '', playerCapTimeBasis: 'play_time', playerCapSticky: true });
    });
    ...
    it('carries non-default playercap host/nxpcPlayer/nxpcBasis/nxpcSticky', () => {
        useStageSettingsStore.setState({ enablePlayerCapStage: true, playerCapHost: '192.168.1.9:8765', playerCapPlayer: 'foobar2000', playerCapTimeBasis: 'timestamp', playerCapSticky: false });
