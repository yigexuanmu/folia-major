...
// shared/lyricSegmentationPrompt.cjs
// Lyric word-segmentation prompt and response parser for Electron's CommonJS main process.
// Mirrors shared/lyricSegmentationPrompt.mjs verbatim; the unit test asserts they agree.
