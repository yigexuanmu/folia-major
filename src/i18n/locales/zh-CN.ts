...
export default {
  ...
  "options": {
    ...
    "transitionAnimationDesc": "混音过渡时在屏幕中央显示，按任意键消失。过渡短于 5 秒不显示。歌曲信息卡片在场时改画在卡片边框上。",
    ...
    "memoryMonitorOffHint": "监控未开启，当前没有采样。",
    "memoryMonitorStart": "开始记录",
    "memoryCurrent": "当前",
    "memoryPeak": "峰值",
    "memoryFloor": "最低",
    "memoryAverage": "平均",
    ...
    "wallpaperMode": "壁纸模式",
    "wallpaperModeDesc": "将应用窗口沉到桌面最底层，作为歌词壁纸常驻显示。Windows 下键盘不可用。",
