...
export default {
  ...
  "options": {
    ...
    "transitionAnimationDesc": "Digambar di tengah layar saat campuran berjalan. Tombol apa pun menutupnya. Tidak ditampilkan untuk transisi di bawah 5 detik. Digambar pada tepi kartu lagu saat kartu itu tampil.",
    ...
    "stageTrackPillDesc": "Kartu now playing di kiri bawah halaman lirik: sembunyi otomatis setelah beberapa saat, atau selalu tampil / tersembunyi.",
    ...
    "stageTrackPillOnHomeDesc": "Nonaktif berarti hanya di halaman lirik. Aktif berlaku kapan saja: saat aplikasi terbuka di halaman utama, saat ganti lagu di halaman utama, atau saat kembali dari halaman lirik.",
    ...
    "wallpaperModeDesc": "Turunkan jendela aplikasi ke dasar desktop dan pertahankan selalu terlihat sebagai wallpaper lirik. Input keyboard tidak tersedia di Windows.",
