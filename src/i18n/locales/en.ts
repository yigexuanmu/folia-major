...
export default {
  ...
  "options": {
    ...
    "transitionAnimationDesc": "Drawn at the centre of the screen while a mix runs. Any key dismisses it. Not shown for transitions under 5 seconds. Drawn on the track card's border instead while that card is on screen.",
    ...
    "wallpaperModeDesc": "Sink the app window to the bottom of the desktop and keep it always visible as a lyrics wallpaper. Keyboard input is unavailable on Windows.",
