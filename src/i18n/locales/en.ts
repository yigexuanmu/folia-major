...
export default {
  ...
  "options": {
    ...
    "songUnlock": "Song Unlock",
    "songUnlockDesc": "When a song is VIP/copyright restricted, automatically look for a playable source from other platforms.",
    "songUnlockEnable": "Enable song unlock",
    "songUnlockServerNetease": "NetEase",
    "songUnlockServerDescNetease": "Via a third-party aggregate API",
    "songUnlockServerBodian": "Bodian Music",
    "songUnlockServerDescBodian": "Kuwo sub-platform, 320 kbps",
    "songUnlockServerKuwo": "Kuwo Music",
    "songUnlockServerDescKuwo": "Kuwo mobile API, 128 kbps",
